 ...
 * 그 경로가 여려겹으로 겹치는 현상이 발생한다
 *
 * React에서 state를 사용한 코딩을 할 때 매우
 * 자주 발생하는 현상이다
 *
 ...
 * PropsLevel1의 함수 컴포넌터를 사용하여 표시하고자 한다
 */

const PropsLevel1 = ({ sample, setSample }) => {
  return (
    <div className="level_1">
      <p>샘플값 : {sample}</p>
      <PropsLevel2 setSample={setSample} />
    </div>
  );
};

const PropsMain = ({ sample, setSample }) => {
  return (
    <div className="main">
      <PropsLevel1 sample={sample} setSample={setSample} />
    </div>
  );
};
