 ...
 * 이 method를 react에서는 lifeCycle method 라고 불렀다
 * 프로젝트가 시작될때, redering이 시작될때, redering이 완료되었을때
 * 현재 화면이 닫힐때 등등의 상황에서 event를 일으킬때 등등..
 *
...
// user Hook
// react에서 기본적으로 제공하는 hook()을 Custmizing하기
// userContext()는 초기에 생성한 Context를 항상 import하여
// 매개변수로 전달해야 하는 불편함이 있다
// AppContext를 바라볼수 있는(직접 접근할 수 있는) 곳에서
 ...
 * 4. 컴포넌트 함수의 매개변수에 {children}을 추가한다
