 ...
 * 서로다른 서버간에 데이터를 주고받을 때 보안문제로 인해
 * 발생할 수 있는 ISSUE
 *
 * XSS 공격
 */
...
// config/mongoConfigSample.json에 Atlas USERID와 PASSWORD를
// 등록한 후 mongoConfig.json으로 변경한 후 실행하시오
const mongoConfig = require("./config/mongoConfig.json");
const mongoAtlas = `mongodb+srv://${mongoConfig.USERID}:${mongoConfig.PASSWORD}@cluster0.ivvgw.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
